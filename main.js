...
'1025': { title: '坏结局', content: '<p>没有提供坏结局的义务！</p><p>不喜欢吃青椒（特例剁碎）不喜欢吃枣，粉面超级suki，讨厌蝴蝶因为是虫子变的，对声音很敏感，不喜欢第二次听到非常讨厌的事情（重点），虎鲸相信未来还有好多好多日子要和黑米粥一起度过，虎鲸会尽力照顾好黑米粥，不让这段感情受伤的.....一定一定，本来这里写了好多好多，但是想起来还是自己发病了啊哈哈哈</p>', signature: '爱你的鲸' },
    '1234': {
        content: `
            <p>你输入这个干啥！</p>
            <p>这是彩蛋喵！</p>
...
<p>如果说宝宝是假装深思熟虑其实是恋爱脑，那虎鲸就是表面恋爱脑背后深思熟虑。其实虎鲸打算全心爱你，是虎鲸自己做的最正确的决定，我超爱这个黑米粥，巴不得每天都粘着宝宝，喜欢你带来的独特感觉，欣赏你刀子嘴豆腐心的性格，害怕你受伤，对伤害你的人万分愤怒，每一次对宝宝说我爱你不只是我轻飘飘的调情，虎鲸从来不会将这种话说得很轻....所以，请允许虎鲸更加更加爱黑米粥好不好！</p>
  ...
  '1009': {
        content: `
            ...
            <p>现在我们两个已经是一对了吧！我就说我们能走过来的！其实是虎鲸才想明白自己在给自己使绊子）虎鲸的债可不轻易那么容易结清的，虎鲸会.....一直会陪着你，我们往前走</p>
    ...
    '1125': {
        ...
        content: `
            <p>还记得这个时刻吗？</p>
            <br>
            <p>我觉得既然是给予别人的礼物就应该去表达正向阳光的一面，虎鲸在20号想了一晚上(一点没睡啊哈哈想了好久)还是把这些内容删掉了，毕竟开心是快乐的日子里的第一要务嘛！虎鲸只是太想解决问题了，请原谅虎鲸的不乖好吗.....虎鲸可以为你做出改变，虎鲸以后不会这样了，虎鲸真的好爱你，想着拼尽全力去爱你，所以请原谅虎鲸的爱错，不舒服一定要提出来哦！感情在虎鲸的理解里就是互相改变和容忍的过程，虎鲸是真的很想和黑米粥一起走好远好远，所以虎鲸很想变成更能让你舒心的样子。</p>
        `,
        signature: '我好爱你'
    },
  '0401': {
 ...
 '1130': {
        content: `
            ...
            <p>即使说过好多好多次，虎鲸还是想说，虎鲸真的很爱很爱你，这份独属于我的浪漫，我可忘不掉！</p>
        `,
        signature: '至死不渝'
    },
 '1201': {
 ...
 '9999': {
        content: `
	     ...
	     <p>虎鲸会一直陪宝宝度过一岁又一岁的</p>
	      <p>不止今天喵！</p>
   	     <p>好想快点见到你，其实虎鲸很口是心非啊哈哈，就是太自卑了！没什么自信....</p>
		<br>
		 <p>生日快乐！</p>
        `,
